...
The current state is `styles.css?v=248`, `app.js?v=327`, `auth.js?v=7`, `sw.js v5.205`, `APP_VERSION = '2.2.0'` (in BOTH `app.js` and `codemagic.yaml`), `HEALTHKIT_AUTH_VERSION = 2`. (Re-check from the files; they drift quickly.)
