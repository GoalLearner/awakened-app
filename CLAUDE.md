...
The current state is `styles.css?v=203`, `app.js?v=270`, `auth.js?v=2`, `sw.js v5.141`, `APP_VERSION = '2.0.2'` (in BOTH `app.js` and `codemagic.yaml`), `HEALTHKIT_AUTH_VERSION = 2`. (Re-check from the files; they drift quickly.)
