...
The current state is `styles.css?v=203`, `app.js?v=268`, `auth.js?v=1`, `sw.js v5.139`, `APP_VERSION = '2.0.2'` (in BOTH `app.js` and `codemagic.yaml`), `HEALTHKIT_AUTH_VERSION = 2`. (Re-check from the files; they drift quickly.)
