...
The current state is `styles.css?v=241`, `app.js?v=320`, `auth.js?v=7`, `sw.js v5.197`, `APP_VERSION = '2.2.0'` (in BOTH `app.js` and `codemagic.yaml`), `HEALTHKIT_AUTH_VERSION = 2`. (Re-check from the files; they drift quickly.)
