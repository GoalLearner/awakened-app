...
The current state is `styles.css?v=226`, `app.js?v=300`, `auth.js?v=7`, `sw.js v5.176`, `APP_VERSION = '2.1.0'` (in BOTH `app.js` and `codemagic.yaml`), `HEALTHKIT_AUTH_VERSION = 2`. (Re-check from the files; they drift quickly.)
