...
The current state is `styles.css?v=259`, `app.js?v=349`, `auth.js?v=8`, `simulated-leaderboard.js?v=4`, `sw.js v5.234`, `APP_VERSION = '2.2.0'` (in BOTH `app.js` and `codemagic.yaml`), `HEALTHKIT_AUTH_VERSION = 2`. (Re-check from the files; they drift quickly.)
