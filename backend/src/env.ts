...
export interface Env {
  ...
  /* W663 — dedicated interactive-PvP write bucket (the friend-Echo summon), so a
   *  live co-op hunt's step-submission drain can't starve it. namespace_id 1024. */
  RL_PVP_WRITE: RateLimit;
