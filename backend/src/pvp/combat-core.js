...
const ARENA_MOVE_LIB = {
  ...
  searing:    { name: 'Searing Cut',  gl: 'burst',  power: 1.1,  acc: 0.9,  cd: 1, fx: { t: 'burn', mag: 0.10, dur: 3 }, desc: 'A cut that smolders.' },
  immolate:   { name: 'Immolate',     gl: 'burst',  power: 1.6,  acc: 0.85, cd: 3, fx: { t: 'burn', mag: 0.10, dur: 2 }, desc: 'Engulf in flame.' },
  ...
  wardstrike: { name: 'Ward Strike',  gl: 'shield', power: 0.7,  acc: 0.95, cd: 2, fx: { t: 'heal', mag: 0.12 }, desc: 'Strike and mend.' },
  ...
  siphon:     { name: 'Siphon',       gl: 'magic',  power: 0.7,  acc: 0.95, cd: 2, fx: { t: 'heal', mag: 0.12 }, desc: 'Drain vitality — strike and mend.' },
  ...
  flamearrow: { name: 'Flame Arrow',  gl: 'ranged', power: 1.1,  acc: 0.9,  cd: 1, fx: { t: 'burn', mag: 0.10, dur: 3 }, desc: 'A shaft wrapped in fire.' },
